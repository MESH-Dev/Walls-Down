    ...
    grunt.initConfig({
        ...
        concat: {
          js: {
            ...
            src: ['assets/js/jquery-1.11.1.min.js','assets/js/featherlight.min.js','assets/js/scripts.js'],
        ...
        watch:{
          ...
          jsconcat:{
            files: ['assets/js/jquery-1.11.1.min.js','assets/js/featherlight.min.js','assets/js/scripts.js'],
            tasks: ['concat']
          } /*,
          jsuglify:{
            files: ['prod/*.js'],
